...
![](asset\images\图片4.png)

![](asset\images\图片5.png)
...
![](asset\images\图片7.png)

- JavaScript 是世界上最流行的语言之一，是一种运行在客户端的脚本语言 （Script 是脚本的意思）
- 脚本语言：不需要编译，运行过程中由 js 解释器( js 引擎）逐行来进行解释并执行
- 现在也可以基于 Node.js 技术进行服务器端编程

	![](asset\images\图片8.png)
...
![](asset\images\图片10.png)

### 3.5 JS 的组成

![](asset\images\图片11.png)
...
- 遵守驼峰命名法。首字母小写，后面单词的首字母需要大写。myFirstName![](asset\images\图片15.png)
...
- 字符串型 String
  ...
  5. 字符串拼接加强
     ...
     ```js
     console.log('pyc' + 18);        // 只要有字符就会相连
     var age = 18;
     console.log('pycage岁啦');      // 这样不行哦
     console.log('pyc' + age);         // pyc18
     console.log('pyc' + age + '岁啦'); // pyc18岁啦
     ```
